...
import leti.tracktice.ads.TasksAd;
...
public class TasksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PreferenceManager.setDefaultValues(TasksActivity.this, R.xml.settings, false);
        sharedPref = PreferenceManager.getDefaultSharedPreferences(TasksActivity.this);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View dialogView = View.inflate(TasksActivity.this, R.layout.dialog_edit_title, null);
                ...
                dialog.show();
                Helper.showKeyboard(TasksActivity.this,edit_title);
            }
        });

        //calling EntriesAd
        db = new TasksAd(TasksActivity.this);
        db.open();
    ...
    private void setTasksList() {
        ...
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(TasksActivity.this, layoutstyle, row, column, xml_id, 0);
